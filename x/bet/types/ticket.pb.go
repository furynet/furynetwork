...
// source: furynetwork/bet/ticket.proto
...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=furynet.furynetwork.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "furynet.furynetwork.bet.BetPlacementTicketPayload")
}

func init() { proto.RegisterFile("furynetwork/bet/ticket.proto", fileDescriptor_cf6959e7db451613) }
