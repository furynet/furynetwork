...
func (Bet_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{0, 0}
}
...
func (Bet_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{0, 1}
}
...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=furynet.furynetwork.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=furynet.furynetwork.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=furynet.furynetwork.bet.Bet_Result" json:"result,omitempty"`
...
func (*Bet) Descriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{0}
}
...
func (*UID2ID) Descriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{1}
}
...
func (*PendingBet) Descriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{2}
}
...
func (*SettledBet) Descriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{3}
}
...
func (*BetFulfillment) Descriptor() ([]byte, []int) {
	return fileDescriptor_5babc7dd42d65118, []int{4}
}
...
func init() {
	proto.RegisterEnum("furynet.furynetwork.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("furynet.furynetwork.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "furynet.furynetwork.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "furynet.furynetwork.bet.UID2ID")
	proto.RegisterType((*PendingBet)(nil), "furynet.furynetwork.bet.PendingBet")
	proto.RegisterType((*SettledBet)(nil), "furynet.furynetwork.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "furynet.furynetwork.bet.BetFulfillment")
}

func init() { proto.RegisterFile("fury/bet/bet.proto", fileDescriptor_5babc7dd42d65118) }

var fileDescriptor_5babc7dd42d65118 = []byte{
	// 885 bytes of a gzipped FileDescriptorProto
	,
}
