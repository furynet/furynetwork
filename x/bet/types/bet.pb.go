...
func init() {
	proto.RegisterEnum("furynetwork.fury.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("furynetwork.fury.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "furynetwork.fury.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "furynetwork.fury.bet.UID2ID")
	proto.RegisterType((*PendingBet)(nil), "furynetwork.fury.bet.PendingBet")
	proto.RegisterType((*SettledBet)(nil), "furynetwork.fury.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "furynetwork.fury.bet.BetFulfillment")
}
