...
// source: fury/market/ticket.proto
...
type MarketAddTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,5,opt,name=status,proto3,enum=furynet.furynetwork.market.MarketStatus" json:"status,omitempty"`
...
func (*MarketAddTicketPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6610f28001b105c, []int{0}
}
...
func (*MarketUpdateTicketPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6610f28001b105c, []int{1}
}
...
type MarketResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status MarketStatus `protobuf:"varint,4,opt,name=status,proto3,enum=furynet.furynetwork.market.MarketStatus" json:"status,omitempty"`
}
...
func (*MarketResolutionTicketPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6610f28001b105c, []int{2}
}
...
func init() {
	proto.RegisterType((*MarketAddTicketPayload)(nil), "furynet.furynetwork.market.MarketAddTicketPayload")
	proto.RegisterType((*MarketUpdateTicketPayload)(nil), "furynet.furynetwork.market.MarketUpdateTicketPayload")
	proto.RegisterType((*MarketResolutionTicketPayload)(nil), "furynet.furynetwork.market.MarketResolutionTicketPayload")
}

func init() { proto.RegisterFile("fury/market/ticket.proto", fileDescriptor_c6610f28001b105c) }

var fileDescriptor_c6610f28001b105c = []byte{
	// 595 bytes of a gzipped FileDescriptorProto
	,
}
